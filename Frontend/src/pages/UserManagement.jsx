...
export default function UserManagement() {
  ...
  const fetchUsers = async () => {
    try {
      const response = await axios.get('https://smart-task-management.onrender.com/api/admin/users');
  ...
  const handleCreateUser = async (e) => {
    ...
    try {
      const response = await axios.post('https://smart-task-management.onrender.com/api/admin/users', formData);
