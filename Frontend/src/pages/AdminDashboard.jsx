...
export default function AdminDashboard() {
  ...
  const fetchAdminData = async () => {
    try {
      const [usersRes, tasksRes, auditRes, statsRes] = await Promise.all([
        axios.get('https://smart-task-management.onrender.com/api/admin/users'),
        axios.get('https://smart-task-management.onrender.com/api/admin/tasks'),
        axios.get('https://smart-task-management.onrender.com/api/admin/audit-logs'),
        axios.get('https://smart-task-management.onrender.com/api/admin/stats')
      ]);
  ...
  const handleToggleUserStatus = async (userId, currentStatus) => {
    ...
    try {
      await axios.put(`https://smart-task-management.onrender.com/api/admin/users/${userId}/status`, { status: newStatus });
  ...
  const handleDeleteUser = async (userId) => {
    if (window.confirm('Are you sure you want to delete this user? This action cannot be undone.')) {
      try {
        await axios.delete(`https://smart-task-management.onrender.com/api/admin/users/${userId}`);
